                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="table-data__info">
                                                            <h6><?php echo $res['uidUsers'];  ?></h6>
                                                            <span>
                                                                <a href="#"><?php echo $res['emailUsers'];?></a>
                                                            </span>
                                                        </div>
                                                    </td>
                                                     <td>
                                                        <span class="role admin"><?php echo $res['userType'];?></span>
                                                    </td>
                                                    <td>
                                                        <div class="rs-select2--trans rs-select2--sm">
                                                            <select class="js-select2" name="userType">
                                                                ...
                                                                if ($res['userType'] == 'admin') {
                                                                    echo '<option selected="selected" value="">Admin</option>';
                                                                }else {
                                                                    echo '<option selected="selected" value="">Customers</option>';
                                                                }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p>Copyright © 2018  seconHandBazar.com </p>
                                </div>
                            </div>
                        </div>
                    </div>
